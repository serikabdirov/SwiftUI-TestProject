    ...
    static func withCustomConfigurations(
        ...
        .settings(
            ...
            configurations: [
                ...
                Configuration.debug(
                    name: .configuration("Mock-Debug"),
                    settings: devDebugSettings,
                    xcconfig: "//Configurations/Mock-Debug.xcconfig"
                ),
                Configuration.release(
                    name: .configuration("Mock-Release"),
                    settings: devReleaseSettings,
                    xcconfig: "//Configurations/Mock-Release.xcconfig"
                ),
                Configuration.debug(
                    name: .configuration("Stage-Debug"),
                    settings: devDebugSettings,
                    xcconfig: "//Configurations/Stage-Debug.xcconfig"
                ),
                Configuration.release(
                    name: .configuration("Stage-Release"),
                    settings: devReleaseSettings,
                    xcconfig: "//Configurations/Stage-Release.xcconfig"
                ),
            ],
